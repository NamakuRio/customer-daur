<template>
    <div>
        <Header title="Pemberitahuan" :left-action="true">
        ...
        <div class="with-header">
            <div>
                <div class="flex flex-col gap-3 p-5">
                    <div class="p-4 border rounded-sm cursor-pointer border-grey-1">
                        <div class="flex items-center justify-between">
                            <h4 class="text-sm font-extrabold text-black">Pembayaran Sukses</h4>
                            <p class="text-xs text-grey-2">2 jam lalu</p>
                        </div>
                        <div class="mt-4">
                            <p class="text-xs text-grey-2">Selamat! Pembayaran untuk transaksi #01292 telah Kami terima</p>
                        </div>
                    </div>
                    <div class="p-4 border rounded-sm cursor-pointer border-grey-1">
                        <div class="flex items-center justify-between">
