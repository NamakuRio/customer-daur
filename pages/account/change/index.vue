            ...
            <div class="p-5">
                <div>
                    <div class="flex flex-col gap-5">
                        ...
                        <div>
                            <label for="name" class="block text-xs text-grey-3">Jenis Akun</label>
                            <select name="" class="block w-full p-4 mt-1 text-xs text-black bg-gray-100 rounded focus:outline-none">
                        ...
                        <div>
                            <label for="name" class="block text-xs text-grey-3">Jenis Kelamin</label>
                            <select name="" class="block w-full p-4 mt-1 text-xs text-black bg-gray-100 rounded focus:outline-none">
                    ...
                    <div class="mt-5">
                        <button class="btn btn--block btn--rounded btn--primary">Perbarui</button>
                    </div>
                </div>
            </div>
        </div>
