          ...
          <div>
            <div class="px-5 py-10">
              <div class="text-center">
                ...
                <h4 class="text-secondary text-xl mt-4 font-[Montserrat]">+6288-382-057-228</h4>
                <div class="mt-7">
                  <p class="text-xs text-grey-2 font-medium">Masukkan kode verifikasi tersebut disini</p>
                  <div class="flex flex-row gap-5 mt-3 items-center justify-center">
                    <input type="text" class="w-full max-w-[53px] max-h-[53px] p-4 text-3xl flex items-center justify-center text-black bg-gray-100 rounded focus:outline-none">
                    <input type="text" class="w-full max-w-[53px] max-h-[53px] p-4 text-3xl flex items-center justify-center text-black bg-gray-100 rounded focus:outline-none">
                    <input type="text" class="w-full max-w-[53px] max-h-[53px] p-4 text-3xl flex items-center justify-center text-black bg-gray-100 rounded focus:outline-none">
                    <input type="text" class="w-full max-w-[53px] max-h-[53px] p-4 text-3xl flex items-center justify-center text-black bg-gray-100 rounded focus:outline-none">
                  </div>
                  <p class="text-xs text-grey-2 max-w-[269px] mx-auto font-medium mt-8">Mohon tunggu maksimal <span class="font-bold text-secondary">50</span> detik untuk mendapatkan kode </p>
                </div>
              </div>
              <div class="mt-48">
                <button class="btn btn--block btn--rounded btn--primary">Konfirmasi</button>
