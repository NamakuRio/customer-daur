                ...
                <div class="px-5 py-10">
                    ...
                    >
                        <div class="text-center">
                            ...
                            >
                                Kami telah mengirimkan kode verifikasi melalui
                                whatsapp ke nomor berikut :
                            </p>
                            <h4
                                class="text-secondary text-xl mt-4 font-[Montserrat]"
                            >
                                {{ phone || '' }}
                            </h4>
                            <div class="mt-7">
        ...
        async verification() {
            try {
                ...
                if (response.success) {
                    ...
                    if (
                        this.$store.state.authentication.prepareVerification
                            .source == 'register'
                    ) {
